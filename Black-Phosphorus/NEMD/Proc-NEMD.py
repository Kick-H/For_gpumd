...
xticks([0, 0.5, 1, 1.5, 2],fontproperties=font_song)
...
subplot(2,2,2)
t_rang=[[0,N_group],[int(len(DATA_ave[0])*percent),len(DATA_ave[0])]]
...
xticks([0, 0.5, 1, 1.5, 2],fontproperties=font_song)
yticks(range(-4000,4001,1000),fontproperties=font_song)
leg=legend(loc='upper left',fontsize=14)
leg.get_frame().set_linewidth(0.)
plt.xlabel('Time (ns)',fontproperties=font_song)
...
xlim(xmin=0.,xmax=2)
ylim(ymin=-8000,ymax=8000)
xticks([0, 0.5, 1, 1.5, 2],fontproperties=font_song)
yticks(range(-8000,8001,2000),fontproperties=font_song)
