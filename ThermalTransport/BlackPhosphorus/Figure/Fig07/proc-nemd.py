...
percent1=float(sys.argv[1])
percent2=float(sys.argv[2])
#percent1=0.8
#percent2=0.9
per_grand1=0.2
per_grand2=0.8
...
print('# > Data sampling interval:',interval,'Number of frames:',N_frame,'Number of group:',N_group,percent1,percent2)
...
start_fit=int(len(x_time)*percent1)
end_fit=int(len(x_time)*percent2)
fit_flux_t1=x_time[start_fit:end_fit]
fit_flux1=DATA_ave[N_group][start_fit:end_fit]
poly_flux1=np.polyfit(fit_flux_t1,fit_flux1,deg=1)
fit_flux2=DATA_ave[N_group+1][start_fit:end_fit]
